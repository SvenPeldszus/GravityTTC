...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Return Type From Lib Link</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see GravityTGG.Rules.RulesPackage#getReturnTypeFromLibLink()
 * @model
 * @generated
 */
public interface ReturnTypeFromLibLink extends EObject, AbstractRule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model
	 ...
	 * @generated
	 */
	void registerObjects_FWD(PerformRuleResult ruleresult, EObject jClass,
			EObject tClass, EObject jClassToTClass, EObject pg, EObject tType,
	 ...
	 * @generated
	 */
	void registerObjects_BWD(PerformRuleResult ruleresult, EObject jClass,
			EObject tClass, EObject jClassToTClass, EObject pg, EObject tType,
			EObject extendedType, EObject tMethodDefinition, EObject jMethod,
			EObject jMethodToTMethodDefinition, EObject extendedTypeToTType);
