...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Return Type User Defined</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see GravityTGG.Rules.RulesPackage#getReturnTypeUserDefined()
 * @model
 * @generated
 */
public interface ReturnTypeUserDefined extends EObject, AbstractRule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model
	 * @generated
	 */
	boolean isAppropriate_FWD(Match match, ExtendedMethodName jMethodName,
	 ...
	 * @generated
	 */
	CSP isAppropriate_solveCsp_FWD(Match match, ExtendedMethodName jMethodName,
			ExtendedClassMethod jMethod, ExtendedType extendedType,
			org.emftext.language.java.classifiers.Class jType,
			ExtendedParameterList extendedParameterList);
	 ...
	 * @generated
	 */
	void registerObjects_FWD(PerformRuleResult ruleresult, EObject jMethodName,
	 ...
	 * @generated
	 */
	void registerObjects_BWD(PerformRuleResult ruleresult, EObject jMethodName,
			EObject tMethodDefinition, EObject jMethod,
			EObject jMethodToTMethodDefinition, EObject extendedType,
			EObject jType, EObject tType, EObject jTypeToTType,
			EObject extendedParameterList);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_28(EMoflonEdge _edge_type);
