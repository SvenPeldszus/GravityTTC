...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Class Method To TMethod Signature</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link GravityTGG.impl.ClassMethodToTMethodSignatureImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link GravityTGG.impl.ClassMethodToTMethodSignatureImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ClassMethodToTMethodSignatureImpl extends
		AbstractCorrespondenceImpl implements ClassMethodToTMethodSignature {
	/**
	 ...
	 * @generated
	 */
	protected ClassMethodToTMethodSignatureImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GravityTGGPackage.Literals.CLASS_METHOD_TO_TMETHOD_SIGNATURE;
	}
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							GravityTGGPackage.CLASS_METHOD_TO_TMETHOD_SIGNATURE__TARGET,
							oldTarget, target));
			}
		}
		return target;
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GravityTGGPackage.CLASS_METHOD_TO_TMETHOD_SIGNATURE__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GravityTGGPackage.CLASS_METHOD_TO_TMETHOD_SIGNATURE__TARGET:
			if (resolve)
				return getTarget();
			return basicGetTarget();
		case GravityTGGPackage.CLASS_METHOD_TO_TMETHOD_SIGNATURE__SOURCE:
			if (resolve)
				return getSource();
	...
	// [user code injected with eMoflon] -->
} //ClassMethodToTMethodSignatureImpl
