 ...
 * <ul>
 *   <li>{@link GravityTGG.impl.CompilationUnitToTClassImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link GravityTGG.impl.CompilationUnitToTClassImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CompilationUnitToTClassImpl extends AbstractCorrespondenceImpl
		implements CompilationUnitToTClass {
	/**
	...
	protected EClass eStaticClass() {
		return GravityTGGPackage.Literals.COMPILATION_UNIT_TO_TCLASS;
	}
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							GravityTGGPackage.COMPILATION_UNIT_TO_TCLASS__TARGET,
							oldTarget, target));
			}
		}
		return target;
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							GravityTGGPackage.COMPILATION_UNIT_TO_TCLASS__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GravityTGGPackage.COMPILATION_UNIT_TO_TCLASS__TARGET:
			if (resolve)
				return getTarget();
			return basicGetTarget();
		case GravityTGGPackage.COMPILATION_UNIT_TO_TCLASS__SOURCE:
			if (resolve)
				return getSource();
