...
public class TPackageImpl extends EObjectImpl implements TPackage {
	...
	public EList<TClass> getContainedClasses() {
		if (containedClasses == null) {
			containedClasses = new EObjectWithInverseResolvingEList<TClass>(
					TClass.class, this,
					TypeGraphBasicPackage.TPACKAGE__CONTAINED_CLASSES,
					TypeGraphBasicPackage.TCLASS__PACKAGE);
		}
	...
	public EList<TPackage> getSubpackage() {
		if (subpackage == null) {
			subpackage = new EObjectContainmentWithInverseEList<TPackage>(
					TPackage.class, this,
					TypeGraphBasicPackage.TPACKAGE__SUBPACKAGE,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetParent(TPackage newParent,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newParent,
				TypeGraphBasicPackage.TPACKAGE__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(TPackage newParent) {
		if (newParent != eInternalContainer()
				|| (eContainerFeatureID() != TypeGraphBasicPackage.TPACKAGE__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TPACKAGE__PARENT, newParent,
					newParent));
	}
	...
	public void setTName(String newTName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TPACKAGE__TNAME, oldTName, tName));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case TypeGraphBasicPackage.TPACKAGE__CONTAINED_CLASSES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getContainedClasses())
					.basicAdd(otherEnd, msgs);
		case TypeGraphBasicPackage.TPACKAGE__SUBPACKAGE:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getSubpackage())
					.basicAdd(otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case TypeGraphBasicPackage.TPACKAGE__CONTAINED_CLASSES:
			return ((InternalEList<?>) getContainedClasses()).basicRemove(
					otherEnd, msgs);
		case TypeGraphBasicPackage.TPACKAGE__SUBPACKAGE:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		case TypeGraphBasicPackage.TPACKAGE__PARENT:
			return eInternalContainer().eInverseRemove(this,
					TypeGraphBasicPackage.TPACKAGE__SUBPACKAGE, TPackage.class,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case TypeGraphBasicPackage.TPACKAGE__CONTAINED_CLASSES:
			...
			getContainedClasses().addAll(
					(Collection<? extends TClass>) newValue);
			return;
		case TypeGraphBasicPackage.TPACKAGE__SUBPACKAGE:
			getSubpackage().clear();
