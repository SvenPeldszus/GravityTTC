 ...
 * @generated
 */
public class TFieldDefinitionImpl extends TMemberImpl implements
		TFieldDefinition {
	/**
			...
			if (signature != oldSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TypeGraphBasicPackage.TFIELD_DEFINITION__SIGNATURE,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSignature(TFieldSignature newSignature,
		...
		if (newSignature != signature) {
			...
			if (signature != null)
				msgs = ((InternalEObject) signature).eInverseRemove(this,
						TypeGraphBasicPackage.TFIELD_SIGNATURE__DEFINITIONS,
						TFieldSignature.class, msgs);
	...
	public TFieldDefinition getHiding() {
		if (hiding != null && hiding.eIsProxy()) {
			...
			if (hiding != oldHiding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TypeGraphBasicPackage.TFIELD_DEFINITION__HIDING,
							oldHiding, hiding));
			}
		}
		return hiding;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetHiding(TFieldDefinition newHiding,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					TypeGraphBasicPackage.TFIELD_DEFINITION__HIDING, oldHiding,
					newHiding);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setHiding(TFieldDefinition newHiding) {
		if (newHiding != hiding) {
			NotificationChain msgs = null;
			if (hiding != null)
				msgs = ((InternalEObject) hiding).eInverseRemove(this,
						TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY,
						TFieldDefinition.class, msgs);
			if (newHiding != null)
				msgs = ((InternalEObject) newHiding).eInverseAdd(this,
						TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY,
						TFieldDefinition.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TFIELD_DEFINITION__HIDING, newHiding,
					newHiding));
	}
	...
	public EList<TFieldDefinition> getHiddenBy() {
		if (hiddenBy == null) {
			hiddenBy = new EObjectWithInverseResolvingEList<TFieldDefinition>(
					TFieldDefinition.class, this,
					TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY,
					TypeGraphBasicPackage.TFIELD_DEFINITION__HIDING);
		}
		return hiddenBy;
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getHiddenBy())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY:
			return ((InternalEList<?>) getHiddenBy()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY:
			getHiddenBy().clear();
			getHiddenBy().addAll(
					(Collection<? extends TFieldDefinition>) newValue);
			return;
		}
