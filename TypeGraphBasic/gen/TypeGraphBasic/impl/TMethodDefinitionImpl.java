 ...
 * @generated
 */
public class TMethodDefinitionImpl extends TMemberImpl implements
		TMethodDefinition {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSignature(TMethodSignature newSignature,
			...
			if (overriding != oldOverriding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDING,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOverriding(
			TMethodDefinition newOverriding, NotificationChain msgs) {
	...
	public void setOverriding(TMethodDefinition newOverriding) {
		if (newOverriding != overriding) {
			NotificationChain msgs = null;
			if (overriding != null)
				msgs = ((InternalEObject) overriding)
						.eInverseRemove(
								this,
								TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDDEN_BY,
								TMethodDefinition.class, msgs);
			if (newOverriding != null)
				msgs = ((InternalEObject) newOverriding)
						.eInverseAdd(
								this,
								TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDDEN_BY,
								TMethodDefinition.class, msgs);
	...
	public EList<TMethodDefinition> getOverriddenBy() {
		if (overriddenBy == null) {
			overriddenBy = new EObjectWithInverseResolvingEList<TMethodDefinition>(
	...
	public EList<TMethodDefinition> getOverloading() {
		if (overloading == null) {
			overloading = new EObjectWithInverseResolvingEList.ManyInverse<TMethodDefinition>(
					TMethodDefinition.class, this,
					TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADING,
					TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADED_BY);
		}
		return overloading;
	}
	...
	public EList<TMethodDefinition> getOverloadedBy() {
		if (overloadedBy == null) {
			overloadedBy = new EObjectWithInverseResolvingEList.ManyInverse<TMethodDefinition>(
					TMethodDefinition.class, this,
					TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADED_BY,
					TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADING);
		}
			...
			if (returnType != oldReturnType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							TypeGraphBasicPackage.TMETHOD_DEFINITION__RETURN_TYPE,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDDEN_BY:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getOverriddenBy())
					.basicAdd(otherEnd, msgs);
		case TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADING:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getOverloading())
					.basicAdd(otherEnd, msgs);
		case TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADED_BY:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getOverloadedBy())
					.basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDDEN_BY:
			return ((InternalEList<?>) getOverriddenBy()).basicRemove(otherEnd,
					msgs);
		case TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADING:
			return ((InternalEList<?>) getOverloading()).basicRemove(otherEnd,
					msgs);
		case TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADED_BY:
			return ((InternalEList<?>) getOverloadedBy()).basicRemove(otherEnd,
					msgs);
		}
