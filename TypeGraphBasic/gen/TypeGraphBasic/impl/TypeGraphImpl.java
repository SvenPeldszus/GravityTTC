...
public class TypeGraphImpl extends EObjectImpl implements TypeGraph {
	...
	public EList<TPackage> getPackages() {
		if (packages == null) {
			packages = new EObjectContainmentEList<TPackage>(TPackage.class,
					this, TypeGraphBasicPackage.TYPE_GRAPH__PACKAGES);
		}
		return packages;
	}
	...
	public EList<TMethod> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentEList<TMethod>(TMethod.class, this,
					TypeGraphBasicPackage.TYPE_GRAPH__METHODS);
		}
		return methods;
	}
	...
	public EList<TField> getFields() {
		if (fields == null) {
			fields = new EObjectContainmentEList<TField>(TField.class, this,
					TypeGraphBasicPackage.TYPE_GRAPH__FIELDS);
		}
		return fields;
	}
	...
	public EList<TClass> getClasses() {
		if (classes == null) {
			classes = new EObjectContainmentEList<TClass>(TClass.class, this,
					TypeGraphBasicPackage.TYPE_GRAPH__CLASSES);
		}
		return classes;
	}
	...
	public void setTName(String newTName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TYPE_GRAPH__TNAME, oldTName, tName));
	}
