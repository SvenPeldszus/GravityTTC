 ...
 * @generated
 */
public class TFieldSignatureImpl extends TSignatureImpl implements
		TFieldSignature {
	/**
	...
	public EList<TFieldDefinition> getDefinitions() {
		if (definitions == null) {
			definitions = new EObjectWithInverseResolvingEList<TFieldDefinition>(
	...
	public TField getField() {
		if (eContainerFeatureID() != TypeGraphBasicPackage.TFIELD_SIGNATURE__FIELD)
			return null;
		return (TField) eContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetField(TField newField,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newField,
				TypeGraphBasicPackage.TFIELD_SIGNATURE__FIELD, msgs);
		return msgs;
	}
	...
	public void setField(TField newField) {
		if (newField != eInternalContainer()
				|| (eContainerFeatureID() != TypeGraphBasicPackage.TFIELD_SIGNATURE__FIELD && newField != null)) {
			...
			if (newField != null)
				msgs = ((InternalEObject) newField).eInverseAdd(this,
						TypeGraphBasicPackage.TFIELD__SIGNATURES, TField.class,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TFIELD_SIGNATURE__FIELD, newField,
					newField));
	}
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TypeGraphBasicPackage.TFIELD_SIGNATURE__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setType(TClass newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TFIELD_SIGNATURE__TYPE, oldType, type));
	}
