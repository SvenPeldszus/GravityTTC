...
public class TClassImpl extends EObjectImpl implements TClass {
			...
			if (package_ != oldPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TypeGraphBasicPackage.TCLASS__PACKAGE, oldPackage,
							package_));
			}
		}
		return package_;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPackage(TPackage newPackage,
			NotificationChain msgs) {
		TPackage oldPackage = package_;
		package_ = newPackage;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, TypeGraphBasicPackage.TCLASS__PACKAGE,
		...
		if (newPackage != package_) {
			...
			if (package_ != null)
				msgs = ((InternalEObject) package_).eInverseRemove(this,
						TypeGraphBasicPackage.TPACKAGE__CONTAINED_CLASSES,
						TPackage.class, msgs);
			if (newPackage != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TCLASS__PACKAGE, newPackage,
					newPackage));
	}
	...
	public EList<TSignature> getSignature() {
		if (signature == null) {
			signature = new EObjectResolvingEList<TSignature>(TSignature.class,
					this, TypeGraphBasicPackage.TCLASS__SIGNATURE);
		}
		return signature;
	}
	...
	public EList<TMember> getDefines() {
		if (defines == null) {
			defines = new EObjectContainmentEList<TMember>(TMember.class, this,
					TypeGraphBasicPackage.TCLASS__DEFINES);
		}
		return defines;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetParentClass(TClass newParentClass,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					TypeGraphBasicPackage.TCLASS__PARENT_CLASS, oldParentClass,
					newParentClass);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setParentClass(TClass newParentClass) {
		if (newParentClass != parentClass) {
			NotificationChain msgs = null;
			if (parentClass != null)
				msgs = ((InternalEObject) parentClass).eInverseRemove(this,
						TypeGraphBasicPackage.TCLASS__CHILD_CLASSES,
						TClass.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TCLASS__PARENT_CLASS, newParentClass,
					newParentClass));
	}
	...
	public EList<TClass> getChildClasses() {
		if (childClasses == null) {
			childClasses = new EObjectWithInverseResolvingEList<TClass>(
					TClass.class, this,
					TypeGraphBasicPackage.TCLASS__CHILD_CLASSES,
					TypeGraphBasicPackage.TCLASS__PARENT_CLASS);
		}
	...
	public void setTName(String newTName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TCLASS__TNAME, oldTName, tName));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case TypeGraphBasicPackage.TCLASS__CHILD_CLASSES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getChildClasses())
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case TypeGraphBasicPackage.TCLASS__DEFINES:
			return ((InternalEList<?>) getDefines())
					.basicRemove(otherEnd, msgs);
		case TypeGraphBasicPackage.TCLASS__PARENT_CLASS:
			return basicSetParentClass(null, msgs);
		case TypeGraphBasicPackage.TCLASS__CHILD_CLASSES:
			return ((InternalEList<?>) getChildClasses()).basicRemove(otherEnd,
					msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case TypeGraphBasicPackage.TCLASS__TNAME:
			return TNAME_EDEFAULT == null ? tName != null : !TNAME_EDEFAULT
					.equals(tName);
		}
