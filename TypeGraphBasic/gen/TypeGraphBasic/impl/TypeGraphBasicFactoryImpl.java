 ...
 * @generated
 */
public class TypeGraphBasicFactoryImpl extends EFactoryImpl implements
	...
	public static TypeGraphBasicFactory init() {
		try {
			TypeGraphBasicFactory theTypeGraphBasicFactory = (TypeGraphBasicFactory) EPackage.Registry.INSTANCE
					.getEFactory(TypeGraphBasicPackage.eNS_URI);
