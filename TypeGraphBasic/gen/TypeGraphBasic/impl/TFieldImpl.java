...
public class TFieldImpl extends EObjectImpl implements TField {
	...
	public EList<TFieldSignature> getSignatures() {
		if (signatures == null) {
			signatures = new EObjectContainmentWithInverseEList<TFieldSignature>(
					TFieldSignature.class, this,
					TypeGraphBasicPackage.TFIELD__SIGNATURES,
					TypeGraphBasicPackage.TFIELD_SIGNATURE__FIELD);
		}
		return signatures;
	}
	...
	public void setTName(String newTName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TFIELD__TNAME, oldTName, tName));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case TypeGraphBasicPackage.TFIELD__SIGNATURES:
			...
			getSignatures().addAll(
					(Collection<? extends TFieldSignature>) newValue);
			return;
		case TypeGraphBasicPackage.TFIELD__TNAME:
