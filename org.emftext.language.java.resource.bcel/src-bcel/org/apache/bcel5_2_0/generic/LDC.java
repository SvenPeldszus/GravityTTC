    ...
    public Object getValue( ConstantPoolGen cpg ) {
        ...
        switch (c.getTag()) {
            ...
            case org.apache.bcel5_2_0.Constants.CONSTANT_Integer:
                return Integer.valueOf(((org.apache.bcel5_2_0.classfile.ConstantInteger) c).getBytes());
            case org.apache.bcel5_2_0.Constants.CONSTANT_Class:
                int nameIndex = ((org.apache.bcel5_2_0.classfile.ConstantClass) c).getNameIndex();
                c = cpg.getConstantPool().getConstant(nameIndex);
                return new ObjectType(((org.apache.bcel5_2_0.classfile.ConstantUtf8) c).getBytes());
