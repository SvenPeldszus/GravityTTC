...
import org.apache.bcel5_2_0.verifier.statics.Pass1Verifier;
import org.apache.bcel5_2_0.verifier.statics.Pass2Verifier;
import org.apache.bcel5_2_0.verifier.statics.Pass3aVerifier;
import org.apache.bcel5_2_0.verifier.structurals.Pass3bVerifier;
 ...
 *
 * @version $Id: Verifier.java 1627977 2014-09-27 15:16:23Z ggregory $
 * @author Enver Haase
 * @see org.apache.bcel5_2_0.verifier.VerifierFactory
 * @see org.apache.bcel5_2_0.verifier.PassVerifier
 */
        ...
        for (Pass3aVerifier pv : p3avs.values()) {
            ...
            for (String element : p3am) {
                messages.add("Pass 3a, method " + meth + " ('"
                        + org.apache.bcel5_2_0.Repository.lookupClass(classname).getMethods()[meth]
                        + "'): " + element);
            }
        }
        ...
        for (int k = 0; k < args.length; k++) {
            try {
                ...
                if (vr == VerificationResult.VR_OK) {
                    JavaClass jc = org.apache.bcel5_2_0.Repository.lookupClass(args[k]);
                ...
                // avoid swapping.
                v.flush();
                org.apache.bcel5_2_0.Repository.clearCache();
                System.gc();
